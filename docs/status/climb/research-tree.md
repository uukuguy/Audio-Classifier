...
> Generated by `tools/climb/regen-tree.py` (deterministic — 15 runs logged)
> Do NOT edit — re-generated on every push / LB landed / cycle complete.

**SOTA**: orthofuse-20260531-0319 = 0.72 (paradigm context-whisper-orthofuse)
...
**Don't ladder (falsified)**: context-v2 (线上0.683) / 廉价声学(BC无效) / 文本词汇(BC无效但帮T/I) / Qwen3-0.6B pooled→LGBM/神经头(冻结pooled对turn-taking无效) / VAP-mel双声道音频(BC0.198<纯ctx0.227) / whisper本机不可行(卡机/太慢) / 切片阈值变体B(砸NA) / rank平均集成C(BC崩) / cloud-whisper-large-v3-vap 冻结encoder+小头(最高0.671<<SOTA 0.712) / context内融合grid/stacking(真分0.679<<SOTA, 4成员不正交nested过拟合, BC0.364→0.200蒸发) / VAP-CPC全量微调单模(真分0.679, vap-cpc-stereo gap≈-0.01, BC0.222与LGBM打平未兑现文献BC+0.3)
...
graph LR
    ...
    class orthofuse_20260531_0319 sota
    stack_fusion_grid_20260531_0129["stack-fusion-grid-20260531-0129<br/>0.68"]
    class stack_fusion_grid_20260531_0129 falsified
    orthofuse_20260531_0319["orthofuse-20260531-0319<br/>0.72"]
    class orthofuse_20260531_0319 sota
